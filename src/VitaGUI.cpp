...
void VitaGUI::Draw(){
	...
	if(state == 0){
		...
		if(clickedMessage){
			...
			vita2d_font_draw_text(vita2dFont[25] , deleteMessageBox.x + 64 , static_cast<int>( messageScrollY + deleteMessageBox.y + deleteMessageBox.h - 8) , RGBA8(255,0,0,255), 25 , "Delete"); 
		}
